...
public class JMLParser extends HandlerBase {
    ...
    public void startTicket(String name, AttributeList attrs) {
    ...
    public void startJob(String name, AttributeList attrs) {
    ...
    public void startCompositeJob(String name, AttributeList attrs) {
        CompositeJob cj;
    ...
    public void startProperty(String name, AttributeList attrs) {
        String pname = attrs.getValue("name");
        String value = attrs.getValue("value");
        currentJob.setProperty(pname, value);
    }

    public void startConsume(String name, AttributeList attrs) {
